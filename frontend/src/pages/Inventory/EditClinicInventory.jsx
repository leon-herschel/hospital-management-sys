...
function EditClinicInventory({ item, onClose, onSuccess }) {
  ...
  try {
    ...
    // ✅ Trigger success in parent (this shows your SuccessModal)
              ...
              <div>
                ...
                <div
                  className={`px-3 py-2 rounded-md font-medium ${
                    determineStatus(formData.quantity) === 'In Stock'
                      ? 'bg-green-100 text-green-800'
                      : determineStatus(formData.quantity) === 'Low Stock'
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <p className="text-sm text-blue-600">
                    New Quantity: <span className="font-medium">{formData.quantity}</span>
                  </p>
                  <p className="text-sm text-blue-600">
                    New Status: <span className="font-medium">{determineStatus(formData.quantity)}</span>
                  </p>
                </div>
              </div>
            </div>
