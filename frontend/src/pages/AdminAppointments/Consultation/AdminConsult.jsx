  ...
  const handleView = (booking) => {
    ...
    const getStats = () => {
      ...
      return {
        ...
        completed: currentBookings.filter((b) => b.status === "Completed")
          .length,
        pending: currentBookings.filter(
          (b) => !b.status || b.status === "Pending"
        ).length,
        confirmed: currentBookings.filter((b) => b.status === "Confirmed")
          .length,
        cancelled: currentBookings.filter((b) => b.status === "Cancelled")
          .length,
      };
    };
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                  Consultation Bookings Consultation Bookings
                </h1>
                        ...
                        >
                                ...
                                <ul className="text-xs text-gray-600 space-y-1">
                                  ...
                                  {booking.patient.complaints.filter(Boolean)
                                    ...
                                    <li className="text-gray-400 text-xs">
                                      +
                                      {booking.patient.complaints.filter(
                                        Boolean
                                      ).length - 2}{" "}
                                      more
                                    </li>
                          ...
                          <td className="px-6 py-4">
                            <div className="flex gap-2">
                              ...
                              <button
                                onClick={() =>
                                  handleDeleteConfirmation(booking)
                                }
