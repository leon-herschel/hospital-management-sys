              ...
              .map((doc) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-green-600">
                    {doc.isGeneralist ? "Yes" : "No"}
                  </td>
                  <td className="px-6 py-4 text-green-600">
                    {doc.isSpecialist ? "Yes" : "No"}
                  </td>
                  ...
                  <td className="px-6 py-4 flex flex-col space-y-2 items-center">
                    ...
                    <button
                      className="bg-teal-600 hover:bg-teal-700 text-white px-4 py-1 rounded-md"
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white rounded-md p-6 w-full max-w-md shadow-lg text-center">
            ...
            <p>
              Are you sure you want to delete <b>{doctorToDelete?.fullName}</b>?
            </p>
